...
```javascript
import papply from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-papply@v0.2.2-deno/mod.js';
```
...
[@stdlib/utils/papply-right]: https://github.com/stdlib-js/utils-papply-right/tree/deno
